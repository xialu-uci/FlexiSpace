...
function ig_fit_all_algs(datafile, savedir, make_model; ig = nothing, optimizers = [nothing] ,maxiters = 10000, save_parameters = false, time_grads = false)
    @load datafile data
...
# function fit_gd(my_prob, ig; optimizers = [nothing], maxiters = 10000, save_parameters = false, time_grads = false)
...
#         gd_result = FlexiBasicLearning.gradient_descent_learn(my_prob, ig; optimizer=optimizer, maxiters=maxiters, save_parameters = save_parameters, time_grads = time_grads)
#         gd_time = time() - t1
#         println("$optimizer time:$gd_time ")
#     end
...
# new function: take igs as a list of initial guesses, and return a list of results for each ig
function fit_all_algs(datafile, savedir, make_model; igs = [nothing], optimizers = [nothing], maxiters = 10000, save_parameters = false, time_grads = false)
    results = []
