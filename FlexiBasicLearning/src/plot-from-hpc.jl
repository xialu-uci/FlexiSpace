...
# const num_points = 20
num_points = 20
expdir  = "../FlexiSpaceLocal/exp/07312026/"
...
for func_key in keys(func_info), d in dofs, shape_key in keys(shapes)
    ...
    try
        ...
        FlexiBasicLearning.plot_loss_and_fits(results) #TODO: Modify plotting calls, test if new structure works for plotting
